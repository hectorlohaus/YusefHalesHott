...
export const metadata = {
  title: 'Consultar Repertorio Conservador | Notaría Traiguén',
  description: 'Buscador público del Repertorio Conservador de la Notaría Traiguén para consultas de inscripciones y registros.',
};
