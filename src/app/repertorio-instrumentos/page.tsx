...
export const metadata = {
  title: 'Consultar Repertorio de Instrumentos Públicos | Notaría Traiguén',
  description: 'Buscador público de escrituras y repertorios de instrumentos públicos de la Notaría Traiguén.',
};
